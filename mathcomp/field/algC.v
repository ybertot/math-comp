...
Parameter conjMixin : Num.NumClosedField.imaginary_mixin_of numDomainType.
Canonical numClosedFieldType := NumClosedFieldType type conjMixin.

Axiom algebraic : integralRange (@ratr unitRingType).

Axiom archiAxiom : Num.archimedean_axiom numDomainType.
Canonical numArchiDomainType := NumArchiDomainType type archiAxiom.
...
Fact archiAxiom : Num.archimedean_axiom numDomainType.
...
Local Notation Cnat := (Num.Theory.Cnat : qualifier 0 algC).
Local Notation Cint := (ArchimedeanTheory.Cint : qualifier 0 algC).
...
Notation algCnumArchi := numArchiDomainType.
...
Notation Cnat := (@Num.Theory.Cnat numArchiDomainType).
Notation Cint := (@ArchimedeanTheory.Cint numArchiDomainType).
...
Lemma Cint0 : 0 \is a Cint. Proof. exact: rpred0. Qed.
Lemma Cint1 : 1 \is a Cint. Proof. exact: rpred1. Qed.
Hint Resolve Cint0 Cint1. (* Trivial cannot resolve a general real0 hint. *)

Lemma Cnat0 : 0 \is a Cnat. Proof. exact: rpred0. Qed.
Lemma Cnat1 : 1 \is a Cnat. Proof. exact: rpred1. Qed.
Hint Resolve Cnat0 Cnat1. (* Trivial cannot resolve a general real0 hint. *)
...
Lemma Cint_rat a : (QtoC a \is a Cint) = (a \in Qint).
Proof.
...
Hint Resolve Creal0 Creal1 Cnat_nat Cnat0 Cnat1.
Hint Resolve Cint_int Cint0 Cint1 floorC0 Crat0 Crat1.
